...
/* Load SOAP package */
require_once('../src/libraries/nusoap.php');
...
class AmazonSearch
{
  ...
  function AmazonSearch($WDSL, $Debug = false)
  {
		global $cfg;
    ...
    /* Create SOAP client */
		if (isset($cfg['http_proxy'])) {
   		$this->Client = new soapclient($WDSL, true, $cfg['http_proxy'], 8080);
		} else {
   		$this->Client = new soapclient($WDSL, true);
		}
